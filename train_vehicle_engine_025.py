...
if __name__ == "__main__":
    ...
    if cfg.DATASET == "cifar10":
        ...
        if cfg.EXPERIMENT.NAME == "state_robust":
        ...
        elif cfg.EXPERIMENT.NAME == "vehicle_engine_025":
            train_data = ''
            if cfg.TRAIN.DATA_PATH == '/home/koh/work/matiec_rampo/examples/vehicle_engine/data_025/done/data_train_vehicle_engine_025_small.json':
            ...
            if cfg.TEST.DATA_PATH == '/home/koh/work/matiec_rampo/examples/vehicle_engine/data_025/done/data_test_vehicle_engine_025_small.json':

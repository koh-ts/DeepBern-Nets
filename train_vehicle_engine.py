...
if __name__ == "__main__":
    ...
    if cfg.DATASET == "cifar10":
        ...
        if cfg.EXPERIMENT.NAME == "state_robust":
        ...
        elif cfg.EXPERIMENT.NAME == "vehicle_engine":
            train_data = ''
            if cfg.TRAIN.DATA_PATH == '/home/koh/work/matiec_rampo/examples/vehicle_engine/data/done/data_train_vehicle_engine_large.json':
            ...
            if cfg.TEST.DATA_PATH == '/home/koh/work/matiec_rampo/examples/vehicle_engine/data/done/data_train_vehicle_engine_large.json':
    ...
    wandb.init(project="vehicle_engine", config={
        "epochs": cfg.TRAIN.EPOCHS,

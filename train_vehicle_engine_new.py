...
if __name__ == "__main__":
    ...
    if cfg.DATASET == "cifar10":
        ...
        elif cfg.EXPERIMENT.NAME == "vehicle_engine_new":
            train_data = ''
            if cfg.TRAIN.DATA_PATH == '/home/koh/work/matiec_rampo/examples/vehicle_engine/data_new/done/data_train_vehicle_engine_new_large.json':
                train_path = cfg.TRAIN.DATA_PATH
            else:
                train_path = '/home/koh/work/matiec_rampo/examples/vehicle_engine/data/done/data_train_vehicle_engine.json'
            if cfg.TEST.DATA_PATH == '/home/koh/work/matiec_rampo/examples/vehicle_engine/data_new/done/data_test_vehicle_engine_new_large.json':
                test_path = cfg.TEST.DATA_PATH
            else:
                test_path = '/home/koh/work/matiec_rampo/examples/vehicle_engine/data/done/data_test_vehicle_engine.json'
            trainloader, testloader = load_staliro(
                batch_size=cfg.TRAIN.BATCH_SIZE, flatten=is_FC_model, type_num=2, data_path_train=train_path, data_path_test=test_path
            )

            # _, benchmark_testloader = load_staliro(
            #     batch_size=cfg.TRAIN.BATCH_SIZE, flatten=is_FC_model, type_num=2, data_path_train=None, data_path_test=None
            # )
        else:
            trainloader, testloader = load_staliro(
    ...
    wandb.init(project="vehicle_engine_new", config={
        "epochs": cfg.TRAIN.EPOCHS,

...
from train_vehicle_engine import compute_robust_loss_regression
import torch
import time
...
def objective(trial):
    try:
        ...
        # wandb.init(project="parameter_tuning_vehicle_engine", config={
        #     "epochs": epochs,
        ...
        trainloader, testloader = load_staliro(batch_size=batch_size, flatten=True, type_num=2, data_path_train='/home/koh/work/matiec_rampo/examples/vehicle_engine/data/done/data_train_vehicle_engine.json', data_path_test='/home/koh/work/matiec_rampo/examples/vehicle_engine/data/done/data_test_vehicle_engine.json')
...
if __name__ == "__main__":
    study = optuna.create_study(direction="minimize",
                                storage='sqlite:///optuna_study_vehicle_engine.db',
                                load_if_exists=True,
    ...
    # with open('/home/koh/work/DeepBern-Nets/optuna_trials_state_robust.json', 'w') as f:
